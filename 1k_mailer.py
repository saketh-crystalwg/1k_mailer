...
\
select a.customer_fk, c.name as merchant_name, txn_date as date_of_reaching_1k, \
...
recipients = ["alberto@crystalwg.com","isaac@crystalwg.com","saketh@crystalwg.com",'marcos@crystalwg.com','anna.penkova@1clickgames.com']
